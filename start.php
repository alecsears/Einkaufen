...
<link rel="apple-touch-icon" href="/einkauf-app/icons/icon-192.png">
...
<body>
  <div class="container py-5">
    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <a href="neue_woche/03_liste.php" class="text-decoration-none">
 ...
 <!-- Wochenmenüs -->
      ...
      <!-- Neuer Wocheneinkauf -->
      <div class="col-12 col-md-6 col-lg-4">
        <a href="neue_woche/01_waehlen.php" class="text-decoration-none">
          <div class="card card-md p-4 bg-white">
            <div class="d-flex align-items-center">
                 <span class="icon-gradient">
