...
<body>
  <div class="container py-4">
    ...
    <form id="rezeptForm" action="speichere_rezept.php" method="post" enctype="multipart/form-data">
      ...
      <!-- Bild-Upload: Nur WebP -->
      <div class="mb-4">
        <label for="bild" class="form-label">Bild (WebP, optional)</label>
        <div class="d-flex align-items-center">
          <input type="file" name="bild" id="bild" class="d-none" accept="image/webp" onchange="previewBild()">
