<?php
// Einkaufsliste aus home/listen/einkaufsliste.json lesen – relativ zu diesem Script
$einkaufslistePfad = __DIR__ . '/../listen/einkaufsliste.json';
$arr = ['offen' => [], 'erledigt' => []];
...
document.getElementById('np_vorratsort').addEventListener('change', (e) => {
  ...
  document.getElementById('np_vorratsort_help').textContent = desc;
    ...
    async function saveEinkaufslisteJson() {
      const r = await fetch('../listen/schreibe_einkaufsliste.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
